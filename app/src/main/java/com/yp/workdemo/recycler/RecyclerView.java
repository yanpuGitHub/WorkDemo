...
import com.yp.workdemo.recycler.AdapterHelper.UpdateOp;
import com.yp.workdemo.recycler.ChildHelper.Callback;
import com.yp.workdemo.recycler.GapWorker.LayoutPrefetchRegistryImpl;
import com.yp.workdemo.recycler.ViewInfoStore.ProcessCallback;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2 {
        ...
        if (className != null) {
            ...
            if (!className.isEmpty()) {
                ...
                try {
                    ...
                    Class<? extends LayoutManager> layoutManagerClass = classLoader.loadClass(className).asSubclass(RecyclerView.LayoutManager.class);
    ...
    public abstract static class LayoutManager {
        ...
        public static int chooseSize(int spec, int desired, int min) {
            ...
            Log.e(TAG, "chooseSize: " + min + "     " + size + "    " + desired);
//            Log.e(TAG, "chooseSize: " + MeasureSpec.EXACTLY + "     " + MeasureSpec.AT_MOST + "     " + MeasureSpec.UNSPECIFIED);

//                Log.e(TAG, "chooseSize: " + mode);
            switch(mode) {
                case -2147483648:
    ...
    public static class RecycledViewPool {
        ...
        public void putRecycledView(RecyclerView.ViewHolder scrap) {
            ...
            ArrayList<ViewHolder> scrapHeap = this.getScrapDataForType(viewType).mScrapHeap;
