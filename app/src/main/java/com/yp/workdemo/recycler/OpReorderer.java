...
import static com.yp.workdemo.recycler.AdapterHelper.UpdateOp;
import static com.yp.workdemo.recycler.AdapterHelper.UpdateOp.ADD;
import static com.yp.workdemo.recycler.AdapterHelper.UpdateOp.MOVE;
import static com.yp.workdemo.recycler.AdapterHelper.UpdateOp.REMOVE;
import static com.yp.workdemo.recycler.AdapterHelper.UpdateOp.UPDATE;
...
class OpReorderer {
    ...
    void swapMoveRemove(List<AdapterHelper.UpdateOp> list, int movePos, UpdateOp moveOp,
